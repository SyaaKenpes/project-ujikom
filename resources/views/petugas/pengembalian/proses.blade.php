...
@section('content')
    <div class="container mx-auto px-4 py-6 max-w-3xl">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <!-- Action form mengarah ke route proses petugas -->
            <form action="{{ route('petugas.pengembalian.proses', $peminjaman->id) }}" method="POST">
                @csrf
                <!-- Hidden ID tetep disimpen buat jaga-jaga -->
                ...
                <!-- SUDAH DIUBAH: name="denda" dan value defaultnya ngambil dari $dendaOtomatis -->
                <input type="hidden" name="denda" id="input-denda" value="{{ $dendaOtomatis }}">

                <div class="flex gap-4">
                    <!-- Tombol batal balik ke index petugas -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // SUDAH DIUBAH: Nyari id input-denda
            const inputDenda = document.getElementById('input-denda');
            ...
            selectKondisi.addEventListener('change', function() {
                ...
                // SUDAH DIUBAH: Update value di input hidden buat dikirim ke Controller pake totalSemua
                inputDenda.value = totalSemua;
            });
        });
    </script>
@endsection
