...
<body class="min-h-screen bg-cover bg-center bg-no-repeat relative flex flex-col justify-between items-center p-4 font-sans"
    ...
    <div class="relative z-10 w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 my-auto animate-fade-in-up">
        
        <!-- Sisi Kiri: Form Login (Diubah jadi bg-black/60 dan backdrop-blur-md) -->
        <div class="p-8 sm:p-10 flex flex-col justify-between bg-black/60 backdrop-blur-md text-white border-y border-l border-white/10 rounded-l-3xl">
            <div>
            ...
            <div class="mt-8 text-center text-xs">
                ...
                <a href="#" class="text-sky-300 hover:text-sky-200 font-medium transition underline">Hubungi Admin</a>
            </div>
        </div>

        <!-- Sisi Kanan: Branding Panel -->
        <div class="bg-[#0b335c] p-8 sm:p-10 flex flex-col items-center justify-center text-center text-white space-y-3 rounded-r-3xl">
            
            <div class="w-24 h-24 mb-1 flex items-center justify-center">
                <!-- Kalau logo udah diremove bg, hapus class mix-blend-screen -->
            ...
            <p class="text-xs text-sky-200 -mt-2 font-medium">Aplikasi Peminjaman alat</p>

            <div class="pt-4 text-xs text-gray-200 space-y-2 max-w-xs">
                <p class="leading-relaxed text-gray-300">
                    Kelola peminjaman dan pengembalian alat sekolah yang:
                </p>
                
                <div class="flex flex-col items-start pl-6 space-y-1.5 pt-1 text-left font-medium">
